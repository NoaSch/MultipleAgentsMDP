...
public class VITutorial extends MDPSolver implements Planner, QProvider{
    ...
    public  VITutorial(SADomain domain, double gamma, HashableStateFactory hashingFactory, ValueFunction vinit, int numIterations) {
    ...
    //check reachablity
    public void performReacabilityFrom(State seedState){
        Set<HashableState> hashStates = StateReachability.getReachableHashedStates(seedState, this.domain, this.hashingFactory);

        //initialize the value function for all states
        for(HashableState hs: hashStates){
    ...
    public double qValue(State s, Action a) {
        ...
        for(TransitionProb tp : tps) {
            ...
            //add contribution weighted by transition probability and discouning the next state
    ...
    public GreedyQPolicy planFromState(State initialState) {
        ...
        this.performReacabilityFrom(initialState);
